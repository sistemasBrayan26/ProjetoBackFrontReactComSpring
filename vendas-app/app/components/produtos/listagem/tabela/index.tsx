        ...
        <tr>
            ...
            <td>
                <div className="buttons">
                    <button className="button is-info is-rounded is-small" onClick={e => onEdit(produto)}>Editar</button>
                    <button className="button is-danger is-rounded is-small" onClick={e => onDelete(produto)}>Excluir</button>
                </div>
            </td>
        </tr>
    )
